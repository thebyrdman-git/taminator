...
For more help on a command:
  tam-rfe <command> --help
    ...
    # ========================================
    # FIX-TABLES command (one-time fix for markdown table rendering)
    # ========================================
    fix_tables_parser = subparsers.add_parser(
        'fix-tables',
        help='Fix markdown tables in all report files in the library',
        description='Add missing separator row after RFE/Bug table headers so tables render correctly. Run once to fix existing reports.'
    )
    fix_tables_parser.add_argument(
        '--dry-run',
        action='store_true',
    ...
    # ========================================
    # DOCS command (full user guide in terminal)
    # ========================================
    subparsers.add_parser(
        'docs',
        help='Show full user guide (in-terminal documentation)',
        description='Print README and GETTING-STARTED documentation. Uses a pager when output is long.'
    )
    ...
    try:
        ...
        elif args.command == 'fix-tables':
            from taminator.commands.fix_tables import main as fix_tables_main
            fix_tables_main(dry_run=args.dry_run)

        elif args.command == 'docs':
            from taminator.commands.docs import main as docs_main
            docs_main()
