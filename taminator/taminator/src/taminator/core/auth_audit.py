...
from .auth_types import AuthType, AuthStatus, AuthResult, TOKEN_REGISTRY, get_token_metadata
...
class AuthAudit:
    ...
    def _display_token_table(self):
        ...
        all_tokens = [AuthType.JIRA_TOKEN, AuthType.PORTAL_TOKEN, AuthType.SUPPORTSHELL_TOKEN]
