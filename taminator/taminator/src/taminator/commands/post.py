...
Posts the formatted report to customer portal group page as a new discussion.
New discussions are created in markdown format by default.
...
# Default format for new discussions created in private portal groups
DEFAULT_DISCUSSION_FORMAT = "markdown"
...
def post_customer_report(customer_name: str, dry_run: bool = False):
    ...
    console.print(f"  • Post report as a new discussion (format: {DEFAULT_DISCUSSION_FORMAT})")
