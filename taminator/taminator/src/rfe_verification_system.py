    ...
    def _define_test_cases(self) -> List[TestCase]:
        ...
        test_cases = [
            ...
            TestCase(
                ...
                severity=TestSeverity.HIGH,
                category="components",
                command="python3 -c 'import os, sys; p = os.environ.get(\"PAI_SRC\"); sys.path.append(p) if p else None; from rfe_monitoring_system import RFEMonitoringSystem; print(\"OK\")'",
                expected_result="OK"
            ),
            TestCase(
                ...
                severity=TestSeverity.HIGH,
                category="components",
                command="python3 -c 'import os, sys; p = os.environ.get(\"PAI_SRC\"); sys.path.append(p) if p else None; from rfe_error_handler import RFEErrorHandler; print(\"OK\")'",
                expected_result="OK"
            ),
            TestCase(
                name="rfe_api_client",
