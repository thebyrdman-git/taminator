...
curl -sSL https://gitlab.cee.redhat.com/grimm/redhat-pai/-/raw/main/contexts/hatter-personality.md > "$PAI_ROOT/redhat/contexts/hatter-personality.md"

# Copy Red Hat configuration
echo "⚙️  Installing Red Hat configuration..."
curl -sSL https://gitlab.cee.redhat.com/grimm/redhat-pai/-/raw/main/config/models.yaml > "$PAI_ROOT/redhat/config/models.yaml"
...
curl -sSL https://gitlab.cee.redhat.com/grimm/redhat-pai/-/archive/main/redhat-pai-main.tar.gz | tar xz
cp redhat-pai-main/bin/* "$PAI_ROOT/redhat/bin/"
...
curl -sSL https://gitlab.cee.redhat.com/grimm/redhat-pai/-/raw/main/GEMINI.md > ~/GEMINI.md
