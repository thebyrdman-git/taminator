...
# Configuration
PAI_CONFIG_DIR = Path.home() / ".config" / "pai"
LOG_DIR = PAI_CONFIG_DIR / "logs"
...
def format_issue_notification(issue_data):
    ...
    # Plain text body
    text_body = f"""New Issue Filed: RFE & Bug Tracker
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p style="margin: 0;">RFE & Bug Tracker Automation</p>
        </div>
        <div class="content">
